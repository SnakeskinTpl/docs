- namespace docs.ru.api['1::Директивы']['14::Создание литералов']['1::func']
...
является функциональной, то она реализует [стандартный механизм декларации параметров](guide#{@@prfx}.html#introParams).
