- namespace docs.en.api['1::Directives']['1::Создание шаблона']['5::block']
...
Директива *block* несёт двойную функциональность: с одной стороны она позволяет создавать [статичные блоки](#guide#{@@prfx}.html#inheritBasic),
...
а т.к. директива *block* является функциональной, то она реализует [стандартный механизм декларации параметров](guide#{@@prfx}.html#introParams).
...
механика наследования практически идентична со статичными блоками и шаблонами, и описана в [отдельной главе](guide#{@@prfx}.html#inheritBlocks).
