- namespace docs.en.api['1::Directives']['14::Creating literals']['1::func']
...
которые требуют аргумент-функцию, например, [series](#series) or [parallel](#parallel).

Директива начинается с ключевого слова `func` (или символов `()` or `() =>`), которое может сопровождаться списком аргументов
