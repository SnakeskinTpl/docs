- namespace docs.ru.api['1::Директивы']['15::Директивы для асинхронной работы']['3::waterfall']
...
асинхронных вызовов. Вместе с директивой *waterfall* должна использоваться директива [callback](#callback).
...
1. `final` - второй параметр Async.waterfall ([функциональная директива](guide.html#introParams)).
