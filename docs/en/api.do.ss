- namespace docs.en.api['1::Directives']['7::Циклы']['3::do']
...
выражение не станет ложным or пока цикл не будет сброшен вручную. Отличие *do* от [while](#while) состоит в том,
...
директивой **while** (заключать выражение в скобки не обязательно).
