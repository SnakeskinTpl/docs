- namespace docs.en.guide['2::Основы']['4::Параметры функциональных директив']
...
Оператор `@` осуществляет привязку параметра к директиве [with](api#{@@prfx}.html#with), например:
