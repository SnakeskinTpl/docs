...
асинхронных вызовов. Вместе с директивой *parallel* должна использоваться директива [callback](#callback).
...
1. `final` - второй параметр Async.parallel ([функциональная директива](guide.html#introParams)).
