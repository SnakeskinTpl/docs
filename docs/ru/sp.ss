- namespace docs.ru.api['Директивы']['10::Работа с пробельными символами']['4::sp']
...
Директива **sp** просто декларирует пробельный символ (актуально только для Jade-Like).
