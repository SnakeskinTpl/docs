- namespace docs.ru.api['Директивы']['8::Итераторы']['2::forIn']
...
а т.к. *forIn* является функциональной директивой, то он реализует [стандартный механизм декларации параметров](guide.html#introParams).
