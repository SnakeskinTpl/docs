...
нужно предварительно создать пространство имён. В рамках одного файла может быть только одно пространство имён.
После задания пространства имён все шаблоны будут экспортироваться по схеме `exports.namespace.template`, например:
...
Если первая часть имени использует синтаксис без квадратных скобок, то в данном файле будет создана локальная
