- namespace docs.ru.api['1::Директивы']['15::Директивы для асинхронной работы']['6::await']
...
Директива используется вместе с async-шаблономи для организации "прерывания", однако, Snakeskin не создаёт
