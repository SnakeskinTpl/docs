- namespace docs.en.api['1::Directives']['5::Переменные']['2::const']
...
и их можно [переопределять в дочернем шаблоне](guide#{@@prfx}.html#inheritConsts).
...
Если любая [функциональная директива](guide#{@@prfx}.html#introParams) содержит параметр с именем равным константе, то он "замещает" константу в рамках
