- namespace docs.ru.guide['3::Наследование']['2::Наследование входных параметров']
...
[with](/api.html#with) биндинг параметров также наследуется, если он не был переопределён явно.
