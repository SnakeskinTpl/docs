...
Модификаторы вида [async](#{@@api}#template--Асинхронный_шаблон) и [генератор](#{@@api}#template--Шаблон-генератор) наследуются
...
[Декораторы шаблонов](#{@@api}#template--Декораторы) также наследуются, а дочерний шаблон может добавить новые,
