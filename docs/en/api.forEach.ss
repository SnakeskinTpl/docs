- namespace docs.en.api['1::Directives']['8::Iterators']['1::forEach']
...
а т.к. *forEach* является функциональной директивой, то он реализует [стандартный механизм декларации параметров](#{@@guide}#introParams).
