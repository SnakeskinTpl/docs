...
Директива **forEach** итерирурует заданный объект (с учётом *hasOwnProperty*) или массив.
...
Директива итерирурует заданное значение с помощью функции `Snakeskin.forEach` и может работать как с объектами, так и с
массивами.
