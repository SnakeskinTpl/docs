- namespace docs.en.api['1::Directives']['13::Modules']['1::include']
...
Обратите внимание, что при подключении файла нужно обязательно указывать символы `./` or `../` для конкретизации поиска,
...
Директива может использоваться только вне шаблонов or внешних блоков.
...
Если в пути к подключаемому файлу явно указать, что это папка (нужно добавить символ `/` в конце пути),
...
### Обработка [параметров трансляции](#{@@guide}#introSet) при подключении
