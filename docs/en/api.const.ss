...
и их можно [переопределять в дочернем шаблоне](#{@@guide}#inheritConsts).
...
Если любая [функциональная директива](#{@@guide}#introParams) содержит параметр с именем равным константе, то он "замещает" константу в рамках
