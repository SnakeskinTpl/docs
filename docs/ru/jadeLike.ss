- namespace docs.ru.guide['2::Основы']['2::Альтернативный синтаксис']
...
Следует заметить, что в альтернативном синтаксисе нет необходимости ставить закрывающие теги для блочных директив,
...
Альтернативный синтаксис можно использовать совместно с классическим, при этом классический синтаксис может включаться
в блоки с декларацией альтернативного, например:
