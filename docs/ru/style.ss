- namespace docs.ru.api['Директивы']['Работа с HTML/XML']['5::style']
...
Директива **style** вставляет в шаблон код декларации тега `<style>` с заданными параметрами.

## Паспорт

| Декларация                                | Короткий синтаксис | Тип директивы      |
|-------------------------------------------|--------------------|--------------------|
| Только внутри шаблонов или внешних блоков | Отсутствует        | Блочная, текстовая |
