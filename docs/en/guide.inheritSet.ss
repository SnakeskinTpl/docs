- namespace docs.en.guide['3::Inheritance']['3::Inheritance параметров трансляции']
...
Допускается переопределение or доопределение параметров трансляции в дочернем шаблоне.
