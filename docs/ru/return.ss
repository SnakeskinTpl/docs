...
Также директива может включать возвращаемое значение в своё тело - это удобно, когда возвращаемое значение является шаблоном,
например:
...
Внутри такой декларации можно использовать любые допустимые директив, например, [if](#if), [forEach](#forEach) и т.д.
