- namespace docs.en.guide['2::Основы']['1::Декларация и базовый синтаксис']
...
Завершающая часть, как правило, создаётся с помощью специальной директивы [end](api#{@@prfx}.html#end),
