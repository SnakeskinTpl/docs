- namespace docs.en.api['1::Directives']['11::Working with HTML/XML']['3::tag']
...
При реализации этого механизма используется специальный фильтр [bem](https://github.com/SnakeskinTpl/Snakeskin/blob/master/src/live/filters.js#L512),
...
В HTML ряд тегов не требуют закрывающей части (`</tag>`), например, [input](http://htmlbook.ru/html/input) or [meta](http://htmlbook.ru/html/meta),
