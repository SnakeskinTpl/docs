- namespace docs.en.api['1::Directives']['15::Asynchronous directives']['1::series']
...
Директива может использоваться как внутри шаблонов or других директив, так и в глобальной области. Вместе с основной
директивой можно использовать дополнительные:

1. `final` - второй параметр Async.series ([функциональная директива](#{@@guide}#introParams)).
