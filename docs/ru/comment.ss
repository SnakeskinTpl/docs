- namespace docs.ru.api['Директивы']['11::Работа с HTML/XML']['7::comment']
...
Директива **comment** вставляет в шаблон код декларации XML комментария с заданными параметрами.
