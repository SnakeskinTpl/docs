- namespace docs.en.api['1::Directives']['17::Разное']['1::op']
...
Директива используется для перехода в [расширенный синтаксис](guide#{@@prfx}.html#basics--Расширенный_синтаксис) без
