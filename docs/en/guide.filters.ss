- namespace docs.en.guide['2::Basics']['5::Механизм фильтров']
...
([template](#{@@api}#template), [forEach](#{@@api}#forEach) и т.д.), например:
...
Название фильтра может начинаться с символа латинского алфавита, подчёркивания (`_`) or знака доллара (`$`).
