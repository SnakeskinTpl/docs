- namespace docs.ru.api['Директивы']['3::Переменные']['3::global']
...
Супер-глобальная переменная Snakeskin - это свойство объекта `Snakeskin.Vars`, т.е. такая переменая доступна как из JavaScript,
