...
Директива **forEach** итерирурует заданную таблицу (с учётом *hasOwnProperty*) или массив.
...
Директива итерирурует заданный объект с помощью функции `Snakeskin.forEach` и может работать как с таблицами, так и с
массивами.
...
Для управления обходом внутри директивы можно использовать директивы:
