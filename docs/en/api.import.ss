- namespace docs.en.api['1::Directives']['13::Модули']['2::import']
...
|--------------------------------------------------------------------|--------------------|-----------------------|--------------|
| Только в глобальной области или на глобальном уровне [head](#head) | Отсутствует        | Строковая, логическая | Не требуется |
...
только в глобальной области или на глобальном уровне директивы *head*.
