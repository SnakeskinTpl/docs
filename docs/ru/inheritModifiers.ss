...
Модификаторы вида [async](api.html#template--Асинхронный_шаблон) и [генератор](api.html#template--Шаблон-генератор) наследуются
...
[Декораторы шаблонов](api.html#template--Декораторы) также наследуются, а дочерний шаблон может добавить новые,
