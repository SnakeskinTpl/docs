- namespace docs.en.guide['3::Inheritance']['2::Наследование входных параметров']
...
При наследовании шаблон or блок наследует входные параметры родителя только в случае явного перечисления,
...
[with](#{@@api}#with) биндинг параметров также наследуется, если он не был переопределён явно.
