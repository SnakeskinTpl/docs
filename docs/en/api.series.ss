- namespace docs.en.api['1::Directives']['15::Директивы для асинхронной работы']['1::series']
...
1. `final` - второй параметр Async.series ([функциональная директива](guide#{@@prfx}.html#introParams)).
