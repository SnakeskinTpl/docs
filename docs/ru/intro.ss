...
Мощный набор возможностей и развитая защита от уязвимостей типа [XSS](http://ru.wikipedia.org/wiki/Межсайтовый_скриптинг) позволяют полностью сосредоточиться на представлении данных, делая его независимым от бизнес-логики.
