- namespace docs.ru.api['Директивы']['1::Создание шаблона']['4::placeholder']
...
Директива **placeholder** декларирует шаблон-плейсхолдер c заданным именем и входными параметрами.
