- namespace docs.ru.api['1::Директивы']['14::Создание литералов']['2::target']
...
Свойства объекту ставяться с помощью директивы [putIn](#putIn). Чтобы получить явную ссылку на созданный объект,
...
[стандартный механизм интерполяции](guide.html#basics--Интерполяция), например:
