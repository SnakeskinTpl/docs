- namespace docs.en.api['1::Directives']['8::Итераторы']['2::forIn']
...
а т.к. *forIn* является функциональной директивой, то он реализует [стандартный механизм декларации параметров](guide#{@@prfx}.html#introParams).
