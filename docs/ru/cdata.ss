- namespace docs.ru.api['Директивы']['12::Экранирование']['1::cdata']
...
Директива **cdata** задаёт блок текста, который вырезается до трансляции, а затем вставляется без изменений в
...
Декларация директивы возможно только с помощью [расширенного синтаксиса](guide.html#basics--Расширенный_синтаксис).
