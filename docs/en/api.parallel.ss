- namespace docs.en.api['1::Directives']['15::Директивы для асинхронной работы']['2::parallel']
...
1. `final` - второй параметр Async.parallel ([функциональная директива](guide#{@@prfx}.html#introParams)).
