- namespace docs.en.api['1::Directives']['2::Выполнение / вывод']['4::return']
...
Большинство [функциональных директив](guide#{@@prfx}.html#introParams) Snakeskin возвращают свой результат автоматически, но
