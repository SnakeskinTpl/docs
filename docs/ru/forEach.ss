- namespace docs.ru.api['1::Директивы']['8::Итераторы']['1::forEach']
...
а т.к. *forEach* является функциональной директивой, то он реализует [стандартный механизм декларации параметров](guide.html#introParams).
