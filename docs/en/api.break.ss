- namespace docs.en.api['1::Directives']['17::Other']['2::break']
...
Поведение директивы *break* зависит от контекста, например, если использовать её внутри циклов or итераторов,
