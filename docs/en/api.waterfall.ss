- namespace docs.en.api['1::Directives']['15::Директивы для асинхронной работы']['3::waterfall']
...
1. `final` - второй параметр Async.waterfall ([функциональная директива](guide#{@@prfx}.html#introParams)).
